 ...
 * Filename	: ADC.H
 * 
 * Author	: Day Yann Fong
 * 
 * Descriptions: 
 * This header file is created based on Explorer16 board PIC24 platform, using 
 * ADC. It contains declaration of of basic general ADC configuration and 
 * operations. It also defines various constants to make ADC settings more 
 * readable.
 * 
**/
...
// ADC related parameter constants
#define ADC_VREF    3.300   
#define ADC_RES     1024    // resolution for 10 bits ADC
...
/* ADC1 Input channel select register (AD1CHS regsiter) */
